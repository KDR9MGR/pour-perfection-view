...
export function ScrollTop() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 right-6 z-40 rounded-full border border-border bg-surface px-4 py-3 text-xs font-bold text-primary shadow-lg transition-all duration-300 ${
